 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_li')){
	function azrcrv_create_plugin_menu_li(){
		azrcrv_create_plugin_menu_table_li();
		azrcrv_populate_plugin_menu_table_li();
	}
}
 ...
 *
 */
if (!function_exists('azrcrv_populate_plugin_menu_table_li')){
	function azrcrv_populate_plugin_menu_table_li(){
		global $wpdb;
 ...
 *
 */
if (!function_exists('azrcrv_create_plugin_menu_table_li')){
	function azrcrv_create_plugin_menu_table_li(){
		global $wpdb;
		$table_name = $wpdb->base_prefix.'azrcrv_plugin_menu';
