...
### [Version 1.2.7](https://github.com/azurecurve/azrcrv-loop-injection/releases/tag/v1.2.7)
 * Update plugin header for compatibility with ClasssicPress v2.
 
### [Version 1.2.6](https://github.com/azurecurve/azrcrv-loop-injection/releases/tag/v1.2.6)
